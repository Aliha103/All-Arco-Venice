    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <section id="booking-section" className="py-16 px-4 max-w-4xl mx-auto">
        <Card className="smooth-hover touch-interaction slide-up"><CardContent className="p-8 space-y-8">
          ...
          <div className="bg-blue-50 rounded-xl p-4 text-sm space-y-1 transition-all duration-300 hover:bg-blue-100"><div className="flex justify-between transition-colors duration-200"><span>Check‑in</span><span>{checkIn||"—"}</span></div><div className="flex justify-between transition-colors duration-200"><span>Check‑out</span><span>{checkOut||"—"}</span></div>{validationErrors.checkOut&&<p className="text-red-600 flex items-center animate-pulse"><AlertCircle className="w-4 h-4 mr-1" />{validationErrors.checkOut}</p>}</div>
          <div className="bg-white rounded-xl p-4 shadow-sm space-y-1 transition-all duration-300 hover:shadow-md"><div className="flex justify-between transition-colors duration-200 hover:text-blue-600"><span>€{discNight.toFixed(2)} × {nights} night{nights!==1&&"s"}</span><span>€{(discNight*nights).toFixed(2)}</span></div><div className="flex justify-between text-sm text-gray-600 transition-colors duration-200 hover:text-gray-800"><span>Cleaning</span><span>€{clean.toFixed(2)}</span></div><div className="flex justify-between text-sm text-gray-600 transition-colors duration-200 hover:text-gray-800"><span>Service</span><span>€{service.toFixed(2)}</span></div>{hasPet&&<div className="flex justify-between text-sm text-gray-600 transition-colors duration-200 hover:text-gray-800"><span>Pet fee</span><span>€{pet.toFixed(2)}</span></div>}<hr className="transition-colors duration-200"/><div className="flex justify-between font-semibold transition-all duration-200 hover:text-blue-600 hover:scale-105"><span>Total</span><span>€{total.toFixed(2)}</span></div></div>
