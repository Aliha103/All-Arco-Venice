...
const SmoobuCalendar: React.FC<CalendarProps> = ({ month: initialMonth }) => {
  ...
  return (
    <div className="w-[45%] sm:w-full mx-auto p-1 sm:p-4 lg:p-8 bg-gradient-to-br from-white to-gray-50 shadow-lg sm:shadow-2xl rounded-lg sm:rounded-2xl border border-gray-200">
