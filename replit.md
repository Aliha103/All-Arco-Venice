...
## Changelog
- June 29, 2025. COMPLETED: Removed Calendar tab and all admin calendar components from codebase as requested. Cleaned up admin dashboard to focus on core management features: Overview, Bookings, Messages, Reviews, and Hero Images. Deleted all calendar-related files and state variables for streamlined admin interface
