...
## Changelog
- June 29, 2025. COMPLETED: Final mobile calendar width optimization - Reduced calendar width to 65% (w-[65%]) for mobile screens only to completely eliminate horizontal scrolling. Increased mobile cell height to 60px (h-15) for better touch targets and content visibility. Added custom h-15 CSS utility class. Updated JavaScript booking span calculations to match new 60px mobile cell height. Calendar maintains full width on tablets and desktops while providing optimal compact mobile experience
