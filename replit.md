...
## Changelog
- June 29, 2025. COMPLETED: Implemented clean Smoobu calendar model with simple grid-based booking visualization. Features color-coded booking sources (Airbnb=red, Booking.com=blue, Direct=green, Blocked=gray, Manual=purple), click-to-book functionality, guest name display on occupied dates, and intuitive legend. Calendar uses clean grid layout with proper day navigation and responsive design following Smoobu's simplified approach
